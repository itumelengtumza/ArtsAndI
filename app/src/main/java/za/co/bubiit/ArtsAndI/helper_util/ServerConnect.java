...
public class ServerConnect {
    ...
    public static final String[] annoucement = new String[]{URL_ANNOUCEMENT_REGISTER, URL_ANNOUCEMENT_PUBLISHER, "DB14", "annoucements", "imageurl", "tittle", "text", "postdate"};
    public static final String downloadDirectory = "Africa & I";
    public static final String[] event = new String[]{URL_EVENT_REGISTER, URL_EVENT_PUBLISHER, "DB11", "events", "email", "imageurl", "name", "startdate", "enddate", "city", "country", "venue", "details", "contact", "postdate", "officialname"};
    ...
    public static final String[] media = new String[]{"Dont Matter", URL_MEDIA_PUBLISHER, "DB16", "media", "mediaurl", "mediaimage", "medianame", "mediadetails", "mediatype", "mediasize", "postdate"};
    public static final String[] notice = new String[]{URL_NOTICE_REGISTER, URL_NOTICE_PUBLISHER, "DB12", "notices", "email", "organization", "notice", "deadline", "division", "contact", "postdate"};
